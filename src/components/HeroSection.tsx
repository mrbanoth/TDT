...
programs and services for tribal communities across India.
              ...
              <div className="flex flex-col sm:flex-row gap-5 w-full sm:w-auto justify-start">
                ...
                <NavLink to="/about" className="w-full sm:w-auto">
                  <Button variant="outline" className="bg-white/5 hover:bg-white/10 hover:text-white text-white border-white/30 hover:border-white/50 px-6 py-3 rounded-full font-normal font-serif text-base sm:text-lg transition-all duration-200 hover:shadow-lg hover:scale-[1.02] tracking-wide w-full max-w-[180px]">
                    Learn More
                  </Button>
                </NavLink>
              </div>
